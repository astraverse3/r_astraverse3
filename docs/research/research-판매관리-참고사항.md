...
관련 문서: [plan-잡곡재고관리.md §판매관리 연동 포인트](../plan/plan-잡곡재고관리.md), [research-잡곡스키마-호출부.md](research-잡곡스키마-호출부.md)
...
1. 본 문서 + [plan-잡곡재고관리.md §판매관리 연동 포인트](../plan/plan-잡곡재고관리.md) 읽고 시작
