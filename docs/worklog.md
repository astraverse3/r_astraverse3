...
### 26년산 연도 경계 10월·11월 → 둘 다 9월 `84a8571`
...
### 생산연도 입력 셀렉트 전환 + 연도 목록 단일 원천화 `6986338`
...
### 대시보드 집계 기준 연도 — DB 최신 → 11월 경계 `aff3ece`
...
### 작목반 등록 연도 셀렉트 · 통계 3곳 연도 기준 통일 `fbf00c9`
...
먼저 **미커밋이던 M1-1·M1-2를 커밋**했다(`569c425`). 이어 M1-3을 얹었다.
