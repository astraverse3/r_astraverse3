...
-  — dry-run 기본, 로 반영. ①찰보리 aliases에 '보리' ②빈 보리 삭제 ③감사로그 2건.
  안전장치: 참조 3종이 0이 아니면 중단 · '보리'를 쓰는 다른 품종 있으면 중단 · 백업 JSON(, 저장소 밖)
- 검증: 「유기농 보리 1kg」·「유기농 찰보리 1kg」 둘 다 SKU#70으로 ✅ · 4kg→#71 ✅ · 검정보리 영향 없음 ✅
- 🔴 **로트번호 안 바뀐다** — 가 '보리' 포함이면 21, '검정'만 215. 보리·찰보리가 원래 같은 코드였다
