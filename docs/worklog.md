...
**2단계로 남긴 것 — 26년산 연도 경계.** 오늘 기준 `lib/production-year.ts`의 벼 경계
(검색 10월 · 등록 11월)가 현실보다 늦어 **이미 등록된 26년산 1행(`#2313` 슬로미2,
입고 9/15)이 기본 목록에서 안 보인다**. 검색·등록 둘 다 9월로 당기기로 결정(사용자).
