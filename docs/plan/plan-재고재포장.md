...
### R2-후속 (다음 작업 — 2026-08-26 사용자 지시, 아직 착수 안 함)

- **재포장 다이얼로그 데스크탑 폭 줄이기** — 현재 `sm:max-w-[940px]`. UI 점검 A안에서 720px 1열 →
  940px 2열로 넓혔는데 실사용에서 과하다. 2열 구조는 유지하면서 폭만 재조정
- **다이얼로그 UI 개선** — 세부 항목은 다음 점검 때 확정
