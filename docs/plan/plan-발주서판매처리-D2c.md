...
### C0-a. 🔴 D2b 결함 수정 — 톤백 열이 중량을 무시한다 ✅ **구현 완료 `a7ee142` (2026-09-11, 브라우저 미확인)**
...
### C0-b. 소계 행 위계 ✅ **구현 완료 `829d6fd` (2026-09-11, 브라우저 미확인)**
...
### C0-c. 채널별 발주처·수령인 표기 규칙 ✅ **확정 (2026-09-11)**
...
### C0-d. 정렬 4종 + `label` 정리 ✅ **구현 완료 `a190394` (2026-09-11, 브라우저 미확인)**
