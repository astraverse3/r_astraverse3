...
// 별칭 학습(#22 · 구 D2e 결정 S·T)은 2026-09-16에 제거했다.
// 발주서 수동지정이 사라져 호출부가 없어졌고, 별칭을 만드는 경로는 품종 관리 화면 하나로 모았다.
// 판정 규칙(다른 품종 이름과 충돌 금지 · 도정 단어 섞임 금지)은 `lib/variety-alias.ts`가 이어받는다.
