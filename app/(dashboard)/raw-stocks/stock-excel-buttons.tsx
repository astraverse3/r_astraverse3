                ...
                {canManage && (
                    <>
                        ...
                        <Button
                            variant="outline"
                            size="sm"
                            className="h-8 w-8 p-0 border-slate-200 bg-slate-50 text-slate-500 hover:bg-primary/20 hover:text-primary hover:border-primary/50 transition-colors"
                                ...
                                {previewResult && (
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-4 gap-2 text-center bg-slate-50 p-3 rounded-lg">
                                            ...
                                            <div>
                                                <div className="text-xs text-emerald-600">등록 가능</div>
                                                <div className="font-bold text-emerald-700">{previewResult.counts.success}건</div>
                                            </div>
                                            <div>
