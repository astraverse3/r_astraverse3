...
export function StockTableRow({ stock }: Props) {
    ...
    return (
        <>
            ...
            >
                {/* 1. Year (Hidden on mobile) */}
                <TableCell className="hidden md:table-cell py-2 px-1 text-center text-xs font-medium text-slate-500 w-[60px]">
                    {stock.productionYear.toString().slice(-2)}년
                </TableCell>

                {/* 2. Variety (Truncated on mobile) */}
                ...
                {/* 3. Farmer (Hidden on mobile) */}
                <TableCell className="hidden md:table-cell py-2 px-1 text-xs text-slate-600">
                    {stock.farmerName}
                </TableCell>

                {/* 4. Cert (Hidden on mobile) */}
                <TableCell className="hidden md:table-cell py-2 px-1 text-center">
