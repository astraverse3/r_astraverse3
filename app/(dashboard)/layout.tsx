    ...
    return (
        <>
            <MillingCartProvider>
                ...
                {/* Main Content Area */}
                <div className="flex-1 flex flex-col min-h-screen bg-transparent lg:pl-64 pt-[44px] pb-20 lg:pt-0 lg:pb-0">
                    ...
                    <main className="flex-1 w-full relative">
                        <div className="max-w-7xl mx-auto px-0 py-1.5 sm:p-6 space-y-1.5 sm:space-y-6 sm:pb-16">
                            {children}
                        </div>
